        ...
        <div className="min-h-screen bg-black flex flex-col lowercase-none">
            ...
            <div className="lg:pl-64 flex-1">
                ...
                <main className="p-4 lg:p-10 space-y-10">
                    ...
                    <div className="bg-[#0c0c0c] p-8 rounded-[2.5rem] border border-neutral-800 shadow-2xl flex flex-col lg:flex-row items-center gap-6 group">
                        <div className="relative flex-1 w-full">
                            ...
                            <input
                                ...
                                className="w-full pl-16 pr-8 py-5 bg-neutral-900 border border-neutral-800 rounded-3xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:bg-black focus:border-indigo-500 font-bold text-white transition-all placeholder:text-neutral-600 placeholder:font-medium"
                            />
                        </div>
                        <button className="w-full lg:w-auto px-10 py-5 bg-neutral-900 text-neutral-400 border border-neutral-800 rounded-3xl font-black uppercase tracking-widest text-[10px] hover:bg-neutral-800 hover:text-white transition-all flex items-center justify-center gap-3 active:scale-95 shadow-inner">
                    ...
                    <div className="bg-[#0c0c0c] rounded-[2.5rem] border border-neutral-800 shadow-2xl overflow-hidden relative group">
                        {/* Desktop View (Table) */}
                        <div className="hidden lg:block overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                <thead className="bg-neutral-900/40 border-b border-neutral-800">
                                    <tr>
                                        <th className="px-10 py-8 text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em] w-24">No</th>
                                        <th className="px-10 py-8 text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em]">
                                            <div className="flex items-center gap-2">NIS <ArrowUpDown className="w-3 h-3 text-indigo-500" /></div>
                                        </th>
                                        <th className="px-10 py-8 text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em]">Nama Lengkap</th>
                                        <th className="px-10 py-8 text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em] text-center">Gender</th>
                                        <th className="px-10 py-8 text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em]">TTL</th>
                                        <th className="px-10 py-8 text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em] text-center">Status</th>
                                        <th className="px-10 py-8 text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em] text-center">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-neutral-800/50">
                                    {filteredData.map((s, i) => (
                                        <tr key={s.id} className="hover:bg-indigo-500/[0.03] transition-colors group/row">
                                            <td className="px-10 py-8 text-xs font-black text-neutral-700 group-hover/row:text-indigo-500/50">{String(i + 1).padStart(2, '0')}</td>
                                            ...
                                            <td className="px-10 py-8 text-[10px] text-neutral-500 font-black uppercase tracking-widest leading-loose">
                        ...
                        <div className="lg:hidden p-6 space-y-6 bg-black/40">
                            {filteredData.map((s, i) => (
                                <div key={s.id} className="bg-neutral-900/40 p-8 rounded-[2.5rem] border border-neutral-800 shadow-xl active:scale-[0.98] transition-all relative overflow-hidden group">
                        ...
                        <div className="p-10 bg-neutral-900/50 border-t border-neutral-800 flex flex-col sm:flex-row items-center justify-between gap-8">
                            ...
                            <div className="flex items-center gap-4">
                                <button className="w-14 h-14 flex items-center justify-center border border-neutral-800 rounded-2xl text-neutral-700 cursor-not-allowed transition-all">
                                    <ChevronLeft className="w-6 h-6" />
                                </button>
                                <button className="w-14 h-14 flex items-center justify-center bg-neutral-900 border border-neutral-800 shadow-xl rounded-2xl text-white hover:bg-indigo-600 hover:text-white hover:border-indigo-500 transition-all active:scale-90">
