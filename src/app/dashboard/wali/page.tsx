        ...
        <div className="min-h-screen bg-[#050505] text-neutral-400 font-sans selection:bg-orange-500/30">
            ...
            <div className="lg:pl-64 flex-1" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                ...
                <main className="w-full px-4 sm:px-6 py-8 lg:p-10 space-y-10 max-w-[1600px] mx-auto overflow-x-hidden">
                    ...
                    <div className={`relative group overflow-hidden rounded-[3rem] bg-[#0c0c0c] border border-neutral-800/40 p-8 lg:p-12 shadow-2xl ${children.length === 1 ? 'lg:max-w-7xl' : children.length === 2 ? 'max-w-6xl' : ''}`}>
                        {/* Glow effect */}
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                            <div className="space-y-4">
                                <div className="inline-flex items-center gap-2 px-3 py-1 bg-orange-500/10 rounded-full text-[10px] font-black uppercase tracking-widest text-orange-500 border border-orange-500/20">
                                    <Heart className="w-3 h-3 fill-current" />
                                    Portal Wali Santri
                                </div>
                                <h1 className="text-3xl lg:text-5xl font-black text-white tracking-tight">
                                    Ahlan wa Sahlan, <br />
                                    <span className="text-orange-500 underline decoration-orange-500/30 underline-offset-8">Bapak/Ibu {user.name.split(' ')[0]}</span>
                                </h1>
                                <p className="text-neutral-500 font-medium max-w-lg text-lg">
                        ...
                        <div className={`grid grid-cols-1 ${children.length === 1 ? 'lg:grid-cols-12 max-w-7xl' : children.length === 2 ? 'lg:grid-cols-2 max-w-6xl' : 'lg:grid-cols-3'} gap-6 lg:gap-10`}>
                            {children.map((child) => (
                                <div
                                    ...
                                    className={`group relative flex flex-col lg:flex-row bg-[#0a0a0a] border border-neutral-800/60 rounded-[4.5rem] overflow-hidden transition-all duration-700 hover:border-orange-500/30 hover:shadow-[0_45px_100px_-25px_rgba(234,88,12,0.12)] ${children.length === 1 ? 'lg:col-span-12' : 'lg:col-span-1'}`}
                                >
                                    {/* Main Info Side */}
                                    <div className={`flex-1 p-10 lg:p-14 ${children.length === 1 ? 'lg:border-r lg:border-neutral-800/50' : ''}`}
                                        ...
                                        <div className="flex items-start justify-between mb-12">
                                            <div className="relative">
                                                ...
                                                <div className="relative w-24 h-24 bg-gradient-to-br from-orange-500 to-amber-600 rounded-[2.5rem] flex items-center justify-center text-4xl font-black text-white shadow-2xl group-hover:scale-110 transition-transform duration-700">
                                                    {child.student_name.charAt(0)}
                                                </div>
                                            </div>
                                            <div className="flex flex-col items-end gap-3">
                                                <div className="px-6 py-3 bg-neutral-900 border border-neutral-800 rounded-2xl text-[11px] font-black text-orange-500 uppercase tracking-widest shadow-lg">
                                                    {child.class_name || 'Formal'}
                                                </div>
                                                <div className="flex items-center gap-2 px-4 py-1.5 bg-emerald-500/5 border border-emerald-500/10 rounded-xl text-[10px] font-bold text-emerald-500 uppercase tracking-widest">
                                        ...
                                        <div className="space-y-4">
                                            <h3 className="text-4xl font-black text-white tracking-tight leading-none group-hover:text-orange-400 transition-colors uppercase">
                                                {child.student_name}
                                            </h3>
                                            <div className="flex items-center gap-3">
                                                <Shield className="w-5 h-5 text-orange-500/40" />
                                                <p className="text-[12px] font-bold text-neutral-600 uppercase tracking-[0.4em]">NIS: {child.nis}</p>
                                            </div>
                                        </div>

                                        <div className="grid grid-cols-2 gap-6 mt-14 mb-10">
                                            <div className="p-7 rounded-[3rem] bg-neutral-950 border border-neutral-900 group-hover:border-neutral-800 transition-colors space-y-3 relative overflow-hidden">
                                                <div className="absolute -right-3 -bottom-3 opacity-[0.04] rotate-12">
                                                    <CreditCard className="w-16 h-16 text-white" />
                                                </div>
                                                <div className="text-[11px] font-black text-neutral-600 uppercase tracking-widest">Syahriah</div>
                                                <div className={`text-base font-black flex items-center gap-2.5 ${Number(child.total_bill_unpaid) > 0 ? 'text-rose-500' : 'text-emerald-500'}`}>
                                            ...
                                            <div className="p-7 rounded-[3rem] bg-neutral-950 border border-neutral-900 group-hover:border-neutral-800 transition-colors space-y-3 relative overflow-hidden">
                                                ...
                                                <div className="text-[11px] font-black text-neutral-600 uppercase tracking-widest">Kedisiplinan</div>
                                                <div className={`text-base font-black ${child.violation_points > 20 ? 'text-rose-500' : 'text-emerald-400'}`}>
                                                    {child.violation_points} <span className="text-xs opacity-60">Poin</span>
                                                </div>
                                            </div>
                                        </div>

                                        <div className="w-full py-6 bg-orange-600 text-white rounded-[2rem] font-black uppercase tracking-[0.3em] text-[10px] flex items-center justify-center gap-5 transition-all duration-300 hover:bg-orange-700 shadow-[0_25px_50px_-15px_rgba(234,88,12,0.4)]">
                                    ...
                                    {children.length === 1 && (
                                        <div className="flex-1 bg-gradient-to-br from-[#0c0c0c] to-[#0a0a0a] p-10 lg:p-14 flex flex-col justify-center">
                                            <div className="space-y-8">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <h4 className="text-white font-black uppercase tracking-widest text-sm">Progres Hafalan</h4>
                                                        <p className="text-neutral-600 text-[10px] font-bold uppercase tracking-[0.2em] mt-1">Capaian Kurikulum Tahfidz</p>
                                                    </div>
                                                </div>

                                                <div className="bg-[#050505]/50 border border-neutral-800/40 rounded-[2.5rem] p-8 space-y-6">
                                                    <div className="flex justify-between items-end">
                                                        <div>
                                                            <p className="text-[10px] font-black text-neutral-600 uppercase tracking-widest mb-2">{hafalanData[child.student_id]?.unitLabel || 'Unit'} Terakhir</p>
                                                            <p className="text-3xl font-black text-white">{hafalanData[child.student_id]?.currentJuz || '...'}</p>
                                                        </div>
                                                        <div className="text-right">
                                                            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-orange-600/10 border border-orange-500/20 rounded-full text-orange-500 font-bold text-[10px] uppercase tracking-widest">
                                                    ...
                                                    <div className="pt-4 flex items-center gap-4 text-neutral-500 text-[10px] font-bold uppercase tracking-[0.2em]">
                                                ...
                                                <button
                                                    ...
                                                    className="w-full py-4 text-neutral-500 hover:text-white font-black uppercase tracking-[0.3em] text-[9px] flex items-center justify-center gap-3 transition-colors group/hafalan"
                                                >
                    ...
                    <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 pb-10 ${children.length === 1 ? 'lg:max-w-7xl' : children.length === 2 ? 'max-w-6xl' : ''}`}>
                        {/* Billing Card */}
                        <div
                            className="p-6 lg:p-8 rounded-[3.5rem] bg-[#0a0a0a] border border-neutral-800/40 flex items-center gap-6 lg:gap-8 group hover:border-orange-500/30 hover:bg-[#0c0c0c] transition-all cursor-pointer shadow-xl relative overflow-hidden"
                            onClick={() => router.push('/dashboard/wali/pembayaran')}
                        >
                            <div className="w-16 h-16 lg:w-20 lg:h-20 bg-orange-600/5 rounded-3xl flex items-center justify-center text-orange-500 border border-orange-500/10 shadow-[0_0_30px_rgba(234,88,12,0.1)] group-hover:bg-orange-600 group-hover:text-white transition-all shrink-0">
                                <CreditCard className="w-7 h-7 lg:w-8 lg:h-8" />
                            </div>
                            <div className="flex-1 min-w-0 pr-2">
                                <h4 className="text-white font-extrabold tracking-tight uppercase text-lg lg:text-xl group-hover:text-orange-500 transition-colors leading-tight">Administrasi Keuangan</h4>
                                <p className="text-neutral-500 text-xs lg:text-sm font-medium mt-1.5 leading-relaxed opacity-80">Pantau iuran SPP & riwayat pembayaran.</p>
                            </div>
                            <div className="w-10 h-10 rounded-full bg-neutral-900 border border-neutral-800 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all -translate-x-4 group-hover:translate-x-0 shrink-0">
                        ...
                        {/* Attendance Card */}
                        <div
                            className="p-6 lg:p-8 rounded-[3.5rem] bg-[#0a0a0a] border border-neutral-800/40 flex items-center gap-6 lg:gap-8 group hover:border-amber-500/30 hover:bg-[#0c0c0c] transition-all cursor-pointer shadow-xl relative overflow-hidden"
                            onClick={() => router.push('/dashboard/wali/absensi')}
                        >
                            <div className="w-16 h-16 lg:w-20 lg:h-20 bg-amber-600/5 rounded-3xl flex items-center justify-center text-amber-500 border border-amber-500/10 shadow-[0_0_30px_rgba(245,158,11,0.1)] group-hover:bg-amber-600 group-hover:text-white transition-all shrink-0">
                                <Calendar className="w-7 h-7 lg:w-8 lg:h-8" />
                            </div>
                            <div className="flex-1 min-w-0 pr-2">
                                <h4 className="text-white font-extrabold tracking-tight uppercase text-lg lg:text-xl group-hover:text-amber-500 transition-colors leading-tight">Riwayat Kehadiran</h4>
                                <p className="text-neutral-500 text-xs lg:text-sm font-medium mt-1.5 leading-relaxed opacity-80">Cek absensi & kedisiplinan harian santri.</p>
                            </div>
                            <div className="w-10 h-10 rounded-full bg-neutral-900 border border-neutral-800 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all -translate-x-4 group-hover:translate-x-0 shrink-0">
